...
This sample code also demonstrates the schema instance validation capability.

Validation results for 18 sample P21 files are presented in the `output` folder.
- sample files: [NIST PMI Models](https://www.mbx-if.org/home/cax/resources/)
